...
def main2():
    ...
    net.eval_on_attack(ProjectedGradientDescent, 0.3, 0, 1, x_train, y_test, chunk_size=10_000)
    net.eval_on_attack(FastGradientMethod, 0.3, 0, 1, x_train, y_test, chunk_size=10_000)
